...
% This file is Junxin Chen's implementation (encryption) of Lan's cipher proposed in 
...
%Encryption
ciphertext=uint8(W_r*double(ciphertext)*W_c);
ciphertext=sub_mod(mask_x,ciphertext);
end
